...
from . import views
from catalog.views import gestion_productos,eliminar_producto,crear_producto,actualizar_producto, gestion_productos_almacen,eliminar_producto_almacen,crear_producto_almacen,actualizar_producto_almacen
from . import views
